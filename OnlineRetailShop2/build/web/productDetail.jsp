                ...
                <div id="background">
                    ...
                    <div id="center"> 
                        <div><img src="images/tpart.png" alt="" width="49" height="23" class="transparent" /><br>
                            ...
                            <c:forEach var="product" items="${aProductDetailList.productList}" varStatus="status"> 

                                <div class="item">   
                                    <h5>${product.productName}</h5>
                                    <div class="itemimage">
                                        <a href="#"><img src="images/${product.productImage}.jpg" alt="" width="300" height="320"/><br /></a><br />
                                        <p class="more1">Category : ${product.productCategory}</p><br />
                                        <p class="more1">Brand : ${product.supplierName}</p><br />
                                        <p class="more1">Full Specification :${product.productSpecification}</p>
                                    ...
                                    <div class="price">
                                        ...
                                        <form action="#" class="button">
                                            <a href="loginTestController"><img src="images/buy.jpg" alt="" width="53" height="23" /></a>
                                        </form>
                                    </div>                                                                  
                                </div>
                    ...
                    <div id="right">
                        <c:forEach var="log" items="${aLoginInfo.loginList}" >
                            <b><i><font color="black">  ${message}&nbsp;&nbsp;</font><font color="green" size="1">${log.firstName}</font></i></b>
                                </c:forEach>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
