...
<jsp:useBean id="aLogin" class="retailshop.Login" scope="session"></jsp:useBean>
    <!DOCTYPE html>
    <html>
        <head>
            ...
            <div id="wrapper">
                <div id="background">
                    ...
                    <div id="center" class="entries">
                        <center><b><i><font color="red" size="5"><u>${myAccount}</u></font></i></b></center>
                        <br /><br /><br />
                        <center>
                            <form action="aLoginInfo" method="post">
                                <c:forEach var="loginInfo" items="${aLoginInfo.loginList}">
                                    Customer Id :&nbsp;&nbsp;&nbsp;<input type="text" name="firstName" value="${loginInfo.uid}" disabled="on click" ><br /><br /><br />
                                    First Name :&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="firstName" value="${loginInfo.firstName}"disabled="on click" >&nbsp;&nbsp;&nbsp;&nbsp;
                                    Last Name :&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="lastName" value="${loginInfo.lastName}"  disabled="on click" ><br /><br /><br />   
                                    Email :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="email" value="${loginInfo.email}"disabled="on click" >&nbsp;&nbsp;&nbsp;&nbsp;
                                    Type:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="type"value="${loginInfo.type}"disabled="on click" /><br /><br /><br />
                                    Address :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="address" value="${loginInfo.address}"disabled="on click" >&nbsp;&nbsp;&nbsp;&nbsp;
                                    Contact :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="contact" value="${loginInfo.contact}"disabled="on click" ><br /><br /><br /><br /><br /><br />
                                </c:forEach>
                            </form> 
                        </center>
                    </div>
                    <div id="right">
                        ...
                        <font face="sans-serif" color="red" size="4"> &nbsp;&nbsp;&nbsp;${warning} </font>
