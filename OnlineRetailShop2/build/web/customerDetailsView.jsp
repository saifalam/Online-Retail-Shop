                ...
                <div id="background">
                    ...
                    <div id="center">
                        <div id="items">
                            ...
                            <center>  
                                <%--   <form actoin="/CustomerDetailsController" method="post">     
                                        <b><i><u><font color="red" size="5">Customer Details Information:</font></u></i></b><br /><br />
                                        <b><font color="red" size="4"> Put Customer Id:</font></b>&nbsp;&nbsp;<input type="text" name="cId" >
                                        <input type="submit" name="details" value="Details"/><br /><br /><br />          
                                    </form>--%>

                                <form action="aCustomerDetailsList" method="post">
                                    <c:forEach var="customerList" items="${aCustomerDetailsList.customerDetailsList}">
                                        Customer ID :&nbsp;&nbsp;&nbsp;<input type="text" name="firstName" value="${customerList.uId}" disabled="on click" ><br /><br /><br />
                                        ...
                                        Transaction ID:&nbsp;&nbsp;&nbsp;<input type="text" name="firstName" value="${customerList.transactionId}" disabled="on click" ><br /><br /><br />
                                        Product ID :&nbsp;&nbsp;&nbsp;<input type="text" name="firstName" value="${customerList.productId}" disabled="on click" ><br /><br /><br />
                                        Quantity :&nbsp;&nbsp;&nbsp;<input type="text" name="firstName" value="${customerList.quantity}" disabled="on click" ><br /><br /><br />
                                        Price :&nbsp;&nbsp;&nbsp;<input type="text" name="firstName" value="${customerList.price}" disabled="on click" ><br /><br /><br />
                                        Sell Date :&nbsp;&nbsp;&nbsp;<input type="text" name="firstName" value="${customerList.sellDate}" disabled="on click" ><br /><br /><br />
                                    </c:forEach> 
                                </form>
                            </center>
                        </div>
