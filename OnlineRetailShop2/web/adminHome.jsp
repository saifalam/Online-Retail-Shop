                                ...
                                <c:if test="${product.productId<7}">
                                    <div class="item">   
                                        ...
                                        <div class="itemimage">
                                            ...
                                            <p class="more"><a href="ProductDetailController?id=${product.productId}">more info</a></p>
                                        </div>
                                        <div class="price">
                                            <p><span class="new">tk.${product.price}</span><span class="old"><strike>$440</strike></span></p><br />
                                            <form action="#" class="button">
                                                <a href="#"><img src="images/buy.jpg" alt="" width="53" height="23" /></a>
                                                <a href="#"><img src="images/shopping.jpg" alt="" width="60" height="30" /></a>
                                            </form>
